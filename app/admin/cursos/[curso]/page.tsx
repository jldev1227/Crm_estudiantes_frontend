        ...
        <div className="space-y-6">
                ...
                <Card className="shadow-sm">
                    <CardHeader className="pb-3">
                        <div className="flex justify-between items-center w-full">
                            <h2 className="text-xl font-bold text-gray-800">Maestros y Áreas Asignadas</h2>
                                    ...
                                    <CardBody className="p-4">
                                        <div className="flex items-center justify-between mb-3">
                                            <div className="flex items-center gap-3">
                                                <Avatar
                                                    name={grupo.maestro.nombre_completo.split(' ').map((n: string) => n[0]).join('')}
                                                    size="md"
                                                    className={grupo.esDirector ? "bg-green-600 text-white" : "bg-gray-600 text-white"}
                                                />
                                                <div>
                                                    <h3 className="font-semibold text-gray-800">
                                                        {grupo.maestro.nombre_completo}
                                                    </h3>
                                                    <p className="text-xs text-gray-600">{grupo.maestro.email}</p>
            ...
            {curso.areas && curso.areas.length > 0 && (
                <Card className="shadow-sm">
                    <CardHeader className="pb-3">
                        <div className="flex justify-between items-center w-full">
                            <h2 className="text-xl font-bold text-gray-800">Todas las Áreas Académicas</h2>
                            <Chip size="sm" color="primary" variant="flat">
                    ...
                    <CardBody className="pt-4">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                            {curso.areas.map((area: any) => (
                                <div key={area.id} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg border hover:bg-gray-100 transition-colors">
                                    <div className="flex items-center gap-3">
                                        <Chip
                                            size="sm"
                                            color={getColorArea(area.nombre)}
                                        ...
                                        <div className="text-xs text-gray-600">
                                            {area.maestro.nombre_completo.split(' ').slice(0, 2).join(' ')}
                                        </div>
                                    </div>
                                    <div className="flex gap-1">
                                        ...
                                        <Tooltip content={`Añadir actividad a ${area.nombre}`}>
                                            <Button
                                                ...
                                                variant="light"
                                                isIconOnly
                                                onPress={() => router.push(`/maestro/cursos/${curso.id}/areas/${area.id}/actividades/nueva`)}
                                            >
                                                <PlusIcon />
                                            </Button>
                                        </Tooltip>
            ...
            <Card className="shadow-sm">
                <CardHeader className="pb-3">
                    <div className="flex justify-between items-center w-full">
                        <h2 className="text-xl font-bold text-gray-800">Estudiantes del Curso</h2>
                        <Chip size="sm" color="success" variant="flat">
