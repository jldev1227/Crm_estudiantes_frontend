...
export default function page() {
    ...
    const fetchData = useCallback(async () => {
        ...
        try {
            ...
            await obtenerCalificaciones(grado_id, periodoSeleccionado);
    ...
    const handlePeriodoChange = (keys) => {
    ...
    return (
        <div className="space-y-6">
                    ...
                    <div className="flex flex-col gap-4 md:flex-row justify-between items-start md:items-center w-full">
                        <div>
                            <h1 className="text-xl md:text-2xl uppercase font-bold text-blue-600">
                                {calificacionesGrado?.grado?.nombre} / {calificacionesGrado?.area?.nombre}
                            </h1>
                            <div className="flex items-center gap-2 mt-2">
                                <Chip size="sm" color="primary" variant="flat">
                                    <Users className="w-3 h-3 mr-1" />
                                    {calificacionesGrado?.estadisticas?.total_estudiantes || 0} estudiantes
                                </Chip>
                                ...
                                <Chip size="sm" color="success" variant="flat">
                                    ...
                                    {calificacionesGrado?.estadisticas?.porcentaje_aprobacion || 0}% aprobación
                                </Chip>
                            </div>
                        </div>
            ...
            {calificacionesGrado?.estadisticas?.sin_calificar > 0 && (
                        ...
                        <div className="flex items-start gap-2 text-yellow-700">
                            ...
                            <div>
                                <p className="font-medium">
                                    {calificacionesGrado.estadisticas.sin_calificar} estudiantes sin calificar
                                </p>
            ...
            <Card className="shadow-sm">
                <CardHeader className="pb-3">
                    <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-3 w-full">
                        <div>
                            <h2 className="text-xl font-bold text-gray-800">Estadísticas del Período</h2>
                ...
                <CardBody className="pt-4">
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                        ...
                        <div className="p-4 rounded-lg border bg-blue-50 border-blue-200">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <span className="text-xs text-gray-600">Promedio General</span>
                                    <p className="font-bold text-lg text-blue-600">
                                        {calificacionesGrado?.estadisticas?.promedio_area?.toFixed(1) || '0.0'}
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    {calificacionesGrado?.estadisticas?.distribucion_notas && (
                        <div className="mt-6">
                            <h3 className="text-md font-semibold mb-3 text-gray-700">Distribución de Notas</h3>
                            <div className="grid grid-cols-2 sm:grid-cols-5 gap-2 text-sm">
                                <div className="bg-green-100 p-2 rounded border text-center">
                                    <span className="text-xs text-gray-600">Excelente (4.5-5.0)</span>
                                    <p className="font-semibold text-green-700">
                                        {calificacionesGrado.estadisticas.distribucion_notas.excelente}
                                    </p>
                                </div>
                                <div className="bg-blue-100 p-2 rounded border text-center">
                                    <span className="text-xs text-gray-600">Sobresaliente (4.0-4.4)</span>
                                    <p className="font-semibold text-blue-700">
                                        {calificacionesGrado.estadisticas.distribucion_notas.sobresaliente}
                                    </p>
                                </div>
                                <div className="bg-yellow-100 p-2 rounded border text-center">
                                    <span className="text-xs text-gray-600">Aceptable (3.5-3.9)</span>
                                    <p className="font-semibold text-yellow-700">
                                        {calificacionesGrado.estadisticas.distribucion_notas.aceptable}
                                    </p>
                                </div>
                                <div className="bg-orange-100 p-2 rounded border text-center">
                                    <span className="text-xs text-gray-600">Insuficiente (3.0-3.4)</span>
                                    <p className="font-semibold text-orange-700">
                                        {calificacionesGrado.estadisticas.distribucion_notas.insuficiente}
                                    </p>
                                </div>
                                <div className="bg-red-100 p-2 rounded border text-center">
                                    <span className="text-xs text-gray-600">Deficiente (1.0-2.9)</span>
                                    <p className="font-semibold text-red-700">
                                        {calificacionesGrado.estadisticas.distribucion_notas.deficiente}
                                    </p>
                                </div>
                            </div>
                        </div>
            ...
            <Card className="shadow-sm">
                <CardHeader className="pb-3">
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 w-full">
                        <div>
                            <h2 className="text-xl font-bold text-gray-800">Calificaciones por Estudiante</h2>
                            <p className="text-sm text-gray-600 mt-1">
                ...
                <CardBody className="pt-4">
                    {calificacionesGrado?.estudiantes?.length > 0 ? (
                        <div className="overflow-x-auto">
                            ...
                            >
                                <TableHeader>
                                    <TableColumn className="min-w-[200px]">ESTUDIANTE</TableColumn>
                                    ...
                                    <TableColumn className="text-center">CALIFICACIONES</TableColumn>
                                        ...
                                        <TableRow key={estudiante.id} className="hover:bg-gray-50">
                                            <TableCell className="font-medium">
                                                <div>
                                                    ...
                                                    <p className="text-xs text-gray-500">ID: {estudiante.id}</p>
                                                </div>
                                            </TableCell>
                                            <TableCell className="text-center">
                                                <div className="text-sm">
                                                    <p>{estudiante.tipo_documento}</p>
                                                    <p className="text-gray-500">{estudiante.numero_identificacion}</p>
                                                </div>
                                            </TableCell>
                                            <TableCell className="text-center">
                                                <Chip
                                            ...
                                            <TableCell className="text-center">
                                                <div className="text-xs">
                                                    {estudiante.notas?.filter(n => n.completada).length || 0}/
