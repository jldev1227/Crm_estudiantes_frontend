            ...
            <div className="flex flex-col sm:flex-row items-center gap-6">
              ...
              <div className="text-center sm:text-left">
                ...
                <div className="flex flex-wrap gap-2 mt-3">
                  <span
                    className={`px-3 py-1 rounded-full text-sm font-medium border ${getRolColor(usuario?.rol || "")}`}
                  >
                    {usuario?.rol?.toUpperCase() || "ADMIN"}
                  </span>
                  <span
                    className={`px-3 py-1 rounded-full text-sm font-medium border ${getEstadoColor(usuario?.activo ?? false)}`}
                  >
                ...
                <div className="w-full">
                  ...
                  <div className="grid sm:grid-cols-2 gap-4 text-sm">
                    ...
                    <div>
                      ...
                      <p
                        className={`mt-1 font-medium ${usuario?.activo ? "text-green-600" : "text-red-600"}`}
                      >
