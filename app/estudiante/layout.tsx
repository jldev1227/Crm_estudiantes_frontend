...
export default function EstudianteLayout({
  ...
  const handleLinkClick = () => {
    if (typeof window !== "undefined" && (window as any).closeAnyOpenModal) {
      (window as any).closeAnyOpenModal();
    }
  };
  ...
  const menuItems = [
    ...
    },
    {
      ...
      icon: CalendarDays,
      label: "Actividades",
      description: "Diarias y eventos",
    },
    {
      href: "/estudiante/calificaciones",
      icon: Award,
      label: "Calificaciones",
      description: "Notas y desempeño",
    },
    {
