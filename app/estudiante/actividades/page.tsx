...
export default function ActividadesPage() {
    ...
    return (
        <div className="container mx-auto px-4">
            <h1 className="text-2xl md:text-3xl font-bold mb-6 text-primary">Actividades</h1>
            ...
            {actividadesFiltradas.length === 0 ? (
                ...
                <div className="space-y-6">
                    {actividadesFiltradas.map((actividad) => (
                        <div key={actividad.id} className="bg-white rounded-lg shadow overflow-hidden">
                            <div className="p-5">
                                <div className="flex justify-between items-start">
                                    <div>
                                        <h2 className="text-xl font-semibold text-gray-800">{actividad.nombre}</h2>
                                        <p className="text-sm text-gray-500 mt-1">{formatearFecha(actividad.fecha)}</p>
