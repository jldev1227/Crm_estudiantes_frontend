      ...
      <div className="min-h-screen bg-white flex flex-col items-center justify-center p-4">
        ...
        <div className="w-full max-w-md space-y-6">
          ...
          <div 
            ...
            className="bg-primary-500 text-white rounded-2xl p-6 shadow-lg flex items-center space-x-6 cursor-pointer transform transition-all duration-300 hover:scale-105 hover:shadow-xl"
          >
          ...
          <div 
            ...
            className="bg-gray-100 rounded-2xl p-6 shadow-lg flex items-center space-x-6 cursor-pointer transform transition-all duration-300 hover:scale-105 hover:shadow-xl"
          >
