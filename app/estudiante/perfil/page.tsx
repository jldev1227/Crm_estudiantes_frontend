...
export default function PerfilEstudiantePage() {
  ...
  const [actualizarContactoEstudiante, { loading }] = useMutation(
    ACTUALIZAR_CONTACTO_ESTUDIANTE,
    {
      onCompleted: (data) => {
          ...
          <div className="p-6 space-y-6">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="flex items-start space-x-4 bg-gray-100 p-4 rounded-xl">
                ...
                <div className="min-w-0 w-full">
                  ...
                  {!editMode.celular_padres ? (
                    <p className="text-gray-600">
                      {usuario?.celular_padres || "No disponible"}
                    </p>
                  ) : (
                    <input
                      className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-primary-500 focus:border-primary-500"
            ...
            <div className="bg-gray-100 p-4 rounded-xl flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Grado:{" "}
                  {usuario?.grado_id ? usuario.grado_nombre : "No asignado"}
                </p>
              </div>
            </div>
          </div>
